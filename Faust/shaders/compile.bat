...
%VULKAN_SDK%/Bin/glslc.exe fullscreen.vert -o fullscreen.vert.spv --target-env=vulkan1.3
%VULKAN_SDK%/Bin/glslc.exe fullscreen.frag -o fullscreen.frag.spv --target-env=vulkan1.3
